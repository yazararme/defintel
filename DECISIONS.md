...
10. **ALARMLAR above the summary** — Rev 9 put the whole alarm section at the top; K5 (client: no alarm-day exemption from the first-screen rule) keeps only the alarm **band** above the headline — the break in familiarity — and moves the ALARMLAR body after the summary at every width. The band links down to it.
